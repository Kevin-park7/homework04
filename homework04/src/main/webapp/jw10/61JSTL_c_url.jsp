...
<h3>ㅇc:url을 이용하여 URL을 만들어(??)보면 </h3>
	...
	<c:url var = "url2" value = "http://127.0.0.1:8080/homework04/jw10/52JSTL_c_import.jsp" scope="session" >
	...
	3. sessionObect에 저장된 url2 사용하기<br/>
		...
		<a href="${ sessionScope.url3 }">어디로 링크가 걸려있나 확인하자...</a> 
		<a href="${ sessionScope.url1 }">어디로 링크가 걸려있나 확인하자...</a> 